...
Make sure you've [installed Laravel Livewire](https://livewire.com/docs/installation/).
...
Optional [Tailwindcss grid](https://tailwindcss.com/docs/grid-template-columns/#app) column width to use for the array field on desktop. 
