...
namespace Naitrons\LivewireForms\Traits;

trait UploadsFiles
{
    public static function fileUpload()
    {
        $storage_disk = self::$storage_disk ?? config('livewire-forms.storage_disk');
        $storage_path = self::$storage_path ?? config('livewire-forms.storage_path');
        $files = [];
